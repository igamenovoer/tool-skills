...
```text
<chosen houmao-mgr launcher> mailbox messages clear --address <full-address> [--mailbox-root <path>] [--dry-run] [--yes]
<chosen houmao-mgr launcher> project mailbox messages clear --address <full-address> [--dry-run] [--yes]
```
