...
- When the resolver returns `gateway: null`, render the matching `agents.mail.list|peek|read|send|reply|mark|move|archive` template as the supported fallback surface.
